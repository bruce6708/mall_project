...
angular.module('pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: '<div class="page-list">' +
            '<ul class="pagination" style="float: left" ng-show="conf.totalItems > 0">' +
            ...
            '</ul>' +
            '<div class="page-total" style="margin-top: 22px;\n' +
            '    margin-left: 30px; float: left;" ng-show="conf.totalItems > 0">' +
